...
def gen_files(url: str):
    ...
    newfolder = os.path.join(base_dir,str(question['questionFrontendId']).zfill(4) + '.' +
                             slug.title())
    ...
    # 生成 main.go 文件
    filepath = os.path.join(base_dir, newfolder, "main.go")
...
if __name__ == '__main__':
    ...
    # 当 url 为空的时候爬取每日一题
    url = input("Enter the leetcode problems url: ")
