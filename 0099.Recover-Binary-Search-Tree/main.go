...
// 我们在走到某个的时候，首先要建桥，就是找到左子树的最大的节点，将他的right节点指向当前的根节点
// 其实已经建立了节点4到节点2的桥了，所以我们走到节点4的的时候，左边如果不为空，则继续搭桥，如果为空的话，我们就往右走，因为我们已经搭好桥了，如果右边为空，那么又会回到2节点，如果不为空就继续探索右边的节点，最终还是会回到节点2的。回到节点2后，我们可以通过查询之前的桥是否搭过了而判断左边是否处理过？我这个理解对吗
